...
void main() async {
  ...
  // Initialize Firebase
  FirebaseApp fb = await Firebase.initializeApp(
    options: DefaultFirebaseOptions.currentPlatform,
  );

  print("Initialzed Firebase App: ${fb.name}");
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void _addDataToFirestore() {
    // FirestoreService().writeMessage("channels", {
    //   "participants": [1, 2],
    //   "message": "Testing",
      ...
      body: Center(
        ...
        child: Column(
          ...
          children: [
            ...
            TextButton(onPressed: _addDataToFirestore, child: Text("Add Data")),
            TextButton(
                ...
                builder: (context, snapshot) {
                  ...
                  return ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      // final msg = messages[index].doc.data()!;
                      ...
                      return ListTile(
                        title: Text(senderId),
                        subtitle: Text(message), // decrypt if E2EE
                      );
                    },
                  );
                },
